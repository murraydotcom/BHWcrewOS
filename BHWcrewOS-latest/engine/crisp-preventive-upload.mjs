...
const CANONICAL_FIELDS = Object.freeze({
  ...
  category: { output: "Category", aliases: ["Category", "Preventive Services Category"] },
  notificationType: { output: "Notification Type", aliases: ["Notification Type"] },
  code: { output: "Code", aliases: ["Code", "Preventive Services Code"] },
  description: { output: "Description", aliases: ["Description", "Preventive Services Description"] },
  results: { output: "Results", aliases: ["Results", "Preventive Services Results"] },
  testName: { output: "Test Name", aliases: ["Test Name", "Preventive Services Test Name"] },
  dataSource: { output: "Data Source", aliases: ["Data Source", "Preventive Services Data Source"] },
  documentEvidenceDate: { output: "Document Evidence Date", aliases: ["Document Evidence Date", "Preventive Services Document Evidence Date"] },
  eventDate: { output: "Event Date", aliases: ["Event Date", "Preventive Services Event Date"] },
  facilityName: { output: "Facility Name", aliases: ["Facility Name", "Facility", "Preventive Services Facility Name"] },
});
