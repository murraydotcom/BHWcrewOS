...
function renderLegacy(record) {
  ...
  $("content").innerHTML = `
    ...
    <nav class="jump-nav" aria-label="Patient 360 sections"><a href="#overview">Overview</a><a href="#atlas">Body-system atlas</a><a href="#timeline">Timeline</a><a href="#mechanism">Mechanism map</a><a href="#context">Context</a><a href="#snapshot">Snapshot & plan</a><a href="#data">Clinical data</a><a href="patient-lab-timeline.html?patient=BHW0000">Laboratory timeline</a><a href="#sources">Sources</a></nav>
