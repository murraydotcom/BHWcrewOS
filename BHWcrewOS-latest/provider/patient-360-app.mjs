...
function bodyFigure(context) {
  ...
  return `<div class="body-center"><div class="body-caption"><span>Whole-person atlas</span><b>${activeSystems.length ? `${activeSystems.length} active system focus` : "No active system focus returned"}</b></div><svg class="body-svg" viewBox="0 0 260 500" role="img" aria-label="Anterior whole-person body outline"><circle class="body-outline" cx="130" cy="42" r="28"/><path class="body-outline" d="M115 72 L113 87 C93 90 80 101 72 122 L45 220 C41 235 48 245 59 240 L88 160 L87 224 C87 250 92 270 101 285 L91 430 C90 449 100 458 111 451 L128 299"/><path class="body-outline" d="M145 72 L147 87 C167 90 180 101 188 122 L215 220 C219 235 212 245 201 240 L172 160 L173 224 C173 250 168 270 159 285 L169 430 C170 449 160 458 149 451 L132 299"/><path class="body-guide" d="M113 87 Q130 98 147 87 M88 160 Q102 182 101 285 M172 160 Q158 182 159 285 M101 285 Q130 297 159 285 M128 299 L130 242 L132 299"/><ellipse class="body-focus-dot" cx="130" cy="184" rx="33" ry="40"/><ellipse class="body-focus-ring" cx="130" cy="184" rx="44" ry="52"/></svg><div class="body-focus-copy"><b>${esc(focus?.label || "Body-system focus not documented")}</b><span>${esc(focus?.summary || "Open the atlas to review documented and unassessed systems.")}</span><a href="patient-360-atlas.html">Open full body-system atlas</a></div></div>`;
}
