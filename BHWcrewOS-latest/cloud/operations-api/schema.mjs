...
export const COLLECTIONS = Object.freeze({
  ...
  patientRequestTeamNotes: "patientRequestTeamNotes",
  patientRequestTeamNoteReads: "patientRequestTeamNoteReads",
  patientRequestTeamNoteMentions: "patientRequestTeamNoteMentions",
